PHPDocker.io - PHP 7.0 / CLI container image
=============================================

Debian Jessie PHP 7.0 CLI container image for [PHPDocker.io](http://phpdocker.io) projects. Packages are provided by [DotDeb.org](https://dotdeb.org).
